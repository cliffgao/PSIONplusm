...
#----------------2010-02-06--------
#-----------Main---Function----------
def api_ss_features(proseq,sseq):
    ### compute the SS features
    #SSdic={'C':0,'H':1,'E':2}
    ss_features=[]
